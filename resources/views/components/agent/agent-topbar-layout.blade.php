...
{{--                                        <div class="d-flex align-items-center">--}}
{{--                                            <img src="{{asset('template/admin/')}}assets/images/products/img-1.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">--}}
{{--                                            <div class="flex-1">--}}
...
{{--                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">--}}
{{--                                        <div class="d-flex align-items-center">--}}
{{--                                            <img src="{{asset('template/admin/')}}assets/images/products/img-2.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">--}}
{{--                                            <div class="flex-1">--}}
{{--                                                <h6 class="mt-0 mb-1 fs-14">--}}
...
{{--                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">--}}
{{--                                        <div class="d-flex align-items-center">--}}
{{--                                            <img src="{{asset('template/admin/')}}assets/images/products/img-3.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">--}}
{{--                                            <div class="flex-1">--}}
{{--                                                <h6 class="mt-0 mb-1 fs-14">--}}
...
{{--                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">--}}
{{--                                        <div class="d-flex align-items-center">--}}
{{--                                            <img src="{{asset('template/admin/')}}assets/images/products/img-6.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">--}}
{{--                                            <div class="flex-1">--}}
{{--                                                <h6 class="mt-0 mb-1 fs-14">--}}
...
{{--                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">--}}
{{--                                        <div class="d-flex align-items-center">--}}
{{--                                            <img src="{{asset('template/admin/')}}assets/images/products/img-5.png" class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">--}}
{{--                                            <div class="flex-1">--}}
{{--                                                <h6 class="mt-0 mb-1 fs-14">--}}
...
{{--                    </div>--}}
                            ...
                            <div class="tab-content position-relative" id="notificationItemsTabContent">
                                <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                <img src="{{asset('template/admin/assets/images/users/avatar-2.jpg')}}" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                <img src="{{asset('template/admin/assets/images/users/avatar-8.jpg')}}" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                                ...
                                <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <img src="{{asset('template/admin/assets/images/users/avatar-3.jpg')}}" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <img src="{{asset('template/admin/assets/images/users/avatar-6.jpg')}}" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{asset('template/admin/assets/images/users/avatar-1.jpg')}}" alt="Header Avatar">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{route('logout')}}" onclick="event.preventDefault();
                                                this.closest('form').submit();"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a></form>
                        </div>
                    </div>
                </div>
            </div>
