                    ...
                    <div class="col mb-4">
                        <div class="row align-items-center pb-4 pb-md-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100">
                            <div class="col-md-5 col-xl-4 pe-lg-0 mb-4-5 mb-lg-0">
                                <div class="border-radius overflow-hidden">
                                    <a href="#">
                                        <img src="{{asset('template/frontend/img/team/team-1.jpg')}}" class="img-fluid" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-7 col-xl-8 ps-lg-4">
                                ...
                                <p class="pt-2 mb-3">
                                    <a href="#" class="custom-view-more d-inline-flex font-weight-semibold text-color-primary text-decoration-none">
                                        View More
                                        <img width="27" height="27" src="{{asset('template/frontend/img/demos/real-estate/icons/arrow-right.svg')}}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary ms-2'}" />
                                    </a>
                                </p>
                            </div>
                        </div>
                        <div class="row align-items-center pb-4 pb-md-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100">
                            <div class="col-md-5 col-xl-4 pe-lg-0 mb-4-5 mb-lg-0">
                                <div class="border-radius overflow-hidden">
                                    <a href="#">
                                        <img src="{{asset('template/frontend/img/team/team-2.jpg')}}" class="img-fluid" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-7 col-xl-8 ps-lg-4">
                        ...
                        <div class="row align-items-center pb-4 pb-md-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100">
                            <div class="col-md-5 col-xl-4 pe-lg-0 mb-4-5 mb-lg-0">
                                <div class="border-radius overflow-hidden">
                                    <a href="#">
                                        <img src="{{asset('template/frontend/img/team/team-3.jpg')}}" class="img-fluid" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-7 col-xl-8 ps-lg-4">
                        ...
                        <div class="row align-items-center pb-4 pb-md-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100">
                            <div class="col-md-5 col-xl-4 pe-lg-0 mb-4-5 mb-lg-0">
                                <div class="border-radius overflow-hidden">
                                    <a href="#">
                                        <img src="{{asset('template/frontend/img/team/team-4.jpg')}}" class="img-fluid" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-7 col-xl-8 ps-lg-4">
                        ...
                        <div class="row align-items-center pb-4 pb-md-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100">
                            <div class="col-md-5 col-xl-4 pe-lg-0 mb-4-5 mb-lg-0">
                                <div class="border-radius overflow-hidden">
                                    <a href="#">
                                        <img src="{{asset('template/frontend/img/team/team-5.jpg')}}" class="img-fluid" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-7 col-xl-8 ps-lg-4">
